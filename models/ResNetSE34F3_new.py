...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, nOut, log_sinc, norm_sinc, encoder_type='SAP', n_mels=40, log_input=True, context=True,out_bn=True ,**kwargs):
...
def MainModel(nOut=256, **kwargs):
    ...
    model = ResNetSE(SEBasicBlock, [3, 4, 6, 3], num_filters, nOut, log_sinc=True, norm_sinc="mean", **kwargs)
    return model
